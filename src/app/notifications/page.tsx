...
import      {/* Dark overlay */}
      ...
      <div className="relative z-10 min-h-screen flex flex-col py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 sm:p-8 shadow-2xl border border-white/20 transition-all duration-300 hover:bg-white/15"> CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
            ...
            <div className="space-y-4">
              {filteredNotifications.length === 0 ? (
                ...
                filteredNotifications.map((notification) => (
                  <Card 
                    key={notification.id} 
                    className={`bg-white/95 backdrop-blur cursor-pointer transition-all duration-200 hover:bg-white/98 ${
