...
export default function ClubDashboard() {
  ...
  if (loading) return (
    ...
    >
      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-2xl border border-white/60">
  ...
  if (!clubs || clubs.length === 0) return (
    ...
    >
      <div className="absolute inset-0 bg-black/10"></div>
      <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-2xl border border-white/60">
        <div className="text-gray-900">No clubs found. You are not assigned as a leader of any club.</div>
      </div>
    </div>
  );
      ...
      <div className="relative z-10 min-h-screen flex flex-col py-8 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl w-full">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 sm:p-8 shadow-2xl border border-white/60 transition-all duration-300 hover:bg-white/85">
            <h1 className="text-3xl font-bold mb-8 text-gray-900">Club Leadership Dashboard</h1>
      <div className="mb-6">
